const PAGES = [
  ...
  { id: 'payment-intent-receipt-matcher.md', path: './payment-intent-receipt-matcher.md', githubPath: 'docs/payment-intent-receipt-matcher.md', label: 'Payment intent receipt matcher', group: 'Builder kit' },
  ...
  { id: 'arc-paid-api-endpoint.md', path: './arc-paid-api-endpoint.md', githubPath: 'docs/arc-paid-api-endpoint.md', label: 'Arc paid API endpoint prototype', group: 'Builder kit' },
